...
#define index_page			"<html>"\
								...
								"<body>"\
									"<div>"\
									"Contorl Relay with WIZwiki-W7500 Web Server"\
									"</div>"\
									"<br>"\
									"<a href='netinfo.html'>Network Inform</a>"\
									"<br>"\
									"<a href='dio.html'>Relay Test</a>"\
									"<br>"\
								"</body>"\
							"</html>"
...
#define dio_page  			"<!DOCTYPE html>"\
							"<html>"\
								...
								"<body>"\
									"<!-- to do -->"\
									"<div>"\
									"<input type='button' value='relay On' pin='7' s='0' onclick='setDiostate(this);'> "\
									"<input type='button' value='relay Off' pin='7' s= '1' onclick='setDiostate(this);'>"\
									"</div>"\
									"<!-- to do -->"\
								"</body>"\
							"</html>"
